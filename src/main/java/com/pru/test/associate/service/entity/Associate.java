...
public class Associate {
	...
	public Associate(Long associateId, String associateName, String ibmId, Long projectId, String engagementName,
			String majorFunction, String band, String primaryContact, String emailIbm, String emailClient, String xid,
			String clientManager, Date endDate, String location, String city, String billType, String billCode,
			String teamOrRole, String role, Date asOnDate, Date clientExpDate, Date itExpDate, Date ibmDate,
			String experienceWithClient, String careerExperience, String experienceWithIbm, String skillset,
	...
	public String toString() {
		return "Associate [associateId=" + associateId + ", associateName=" + associateName + ", ibmId=" + ibmId
				...
				+ ", band=" + band + ", primaryContact=" + primaryContact + ", emailIbm=" + emailIbm + ", emailClient="
				+ emailClient + ", xid=" + xid + ", clientManager=" + clientManager + ", endDate=" + endDate
				+ ", location=" + location + ", city=" + city + ", billType=" + billType + ", billCode=" + billCode
				+ ", teamOrRole=" + teamOrRole + ", role=" + role + ", asOnDate=" + asOnDate + ", clientExpDate="
